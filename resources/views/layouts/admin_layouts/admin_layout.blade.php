...
<head>
  ...
  <link rel="stylesheet" href="{{ url('plugins/moment/moment.min.js') }}">
  <link rel="stylesheet" href="{{ url('plugins/inputmask/min/jquery.inputmask.bundle.min.js') }}">
  <!-- summernote -->
