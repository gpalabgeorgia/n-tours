                ...
                <div class="row pt-115">
                    ...
                    <div class="col-lg-6">
                        <div class="inner-content-about">
                                        ...
                                        world</span>
                            <h2 class="title-heading mb-18 fadeInUp wow">
                                Great opportunity for <span class="text-gray font-yes">adventure</span>
                                & travels
                            </h2>
                                        ...
                                        <div class="icon flex-three">
                                            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <g mask="url(#mask0_40_476)">
                                                    ...
                                                    <path d="M26.9598 9.14062H34.1406V34.1406H26.5035C23.5528 34.1406 20.933 36.0287 20 38.8281" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    <path d="M13.0402 9.14062H5.85938V34.1406H13.4965C16.4472 34.1406 19.067 36.0287 20 38.8281" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                    ...
                                                    <path d="M22.3438 8.20312C22.3438 9.4975 21.2944 10.5469 20 10.5469C18.7056 10.5469 17.6562 9.4975 17.6562 8.20312C17.6562 6.90875 18.7056 5.85937 20 5.85937C21.2944 5.85937 22.3438 6.90875 22.3438 8.20312Z" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                </g>
                                            </svg>
                                        </div>
                                        <h6 class="title mb-10">
                                            <a href="#">Pesonalized Trips</a>
                                        </h6>
                                        <p class="des">Welcome to our Print 128 wesit! company that offers a
                                            wide r</p>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="center m0-auto w-text-heading">
                                        <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                        world</span>
                            <h2 class="title-heading mb-40 fadeInUp wow">
                                Amazing Featured Tour <span class="text-gray font-yes">Package</span>
                                the world
                            </h2>
                        </div>
                        <div class="tab-tour-list">
                            <ul class="nav justify-content-center tab-list mb-37" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="new-york-tab" data-bs-toggle="tab" data-bs-target="#new-york-tab-pane" type="button" role="tab" aria-controls="new-york-tab-pane" aria-selected="true">New York</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="london-tab" data-bs-toggle="tab" data-bs-target="#london-tab-pane" type="button" role="tab" aria-controls="london-tab-pane" aria-selected="false">London</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="tokyo-tab" data-bs-toggle="tab" data-bs-target="#tokyo-tab-pane" type="button" role="tab" aria-controls="tokyo-tab-pane" aria-selected="false">Tokyo</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="los-angelas-tab" data-bs-toggle="tab" data-bs-target="#los-angelas-tab-pane" type="button" role="tab" aria-controls="los-angelas-tab-pane" aria-selected="false">Los
                                        Angelas</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="manila-tab" data-bs-toggle="tab" data-bs-target="#manila-tab-pane" type="button" role="tab" aria-controls="manila-tab-pane" aria-selected="false">Manila</button>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="new-york-tab-pane" role="tabpanel" aria-labelledby="new-york-tab" tabindex="0">
                                    <div class="row">
                                                ...
                                                <a href="tour-single.html" class="tour-listing-image">
                                                    <div class="badge-top flex-two">
                                                        ...
                                                        <div class="badge-media flex-five">
                                                            ...
                                                            <span class="media">
                                                                            <i class="icon-Group-1000002910"></i>
                                                                            2
                                                                        </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tour-listing-content">
                                                    ...
                                                    <div class="flex-two">
                                                        <div class="price-box flex-three">
                                                            <p>
                                                                From <span class="price-sale">$169.00</span>
                                                            </p>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="tour-listing wow fadeInUp animated " data-wow-delay="0.2s">
                                                <a href="tour-single.html" class="tour-listing-image">
                                                    <div class="badge-top flex-two">
                                                        <span class="feature">Featured</span>
                                                        <div class="badge-media flex-five">
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="tour-listing wow fadeInUp animated " data-wow-delay="0.3s">
                                                <a href="tour-single.html" class="tour-listing-image">
                                                    <div class="badge-top flex-two">
                                                        <span class="feature">Featured</span>
                                                        <div class="badge-media flex-five">
                                                    ...
                                                    <div class="icon-box flex-three">
                                                        ...
                                                        <div class="icons flex-three">
                                                            <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M4.34766 4.79761C4.34766 2.94013 5.85346 1.43433 7.71094 1.43433C9.56841 1.43433 11.0742 2.94013 11.0742 4.79761C11.0742 6.65508 9.56841 8.16089 7.71094 8.16089C5.85346 8.16089 4.34766 6.65508 4.34766 4.79761Z" stroke="currentColor" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M9.5977 15.1797H2.46098C1.34827 15.1797 0.558268 14.0954 0.898984 13.0362C1.80408 10.222 4.57804 8.18566 7.69301 8.18566C9.17897 8.18566 10.5566 8.64906 11.6895 9.43922" stroke="currentColor" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M17.1035 15.1797V9.02734" stroke="#4DA528" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M20.1797 12.1035H14.0273" stroke="#4DA528" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                            </svg>
                                                            <span>12 Person</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="tour-listing wow fadeInUp animated " data-wow-delay="0.4s">
                                                <a href="tour-single.html" class="tour-listing-image">
                                                    <div class="badge-top flex-two">
                                                        <span class="feature">Featured</span>
                                                        <div class="badge-media flex-five">
                                                ...
                                                <div class="tour-listing-content">
                                                    ...
                                                    <div class="icon-box flex-three">
                                                        ...
                                                        <div class="icons flex-three">
                                                            <svg width="21" height="16" viewBox="0 0 21 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M4.34766 4.79761C4.34766 2.94013 5.85346 1.43433 7.71094 1.43433C9.56841 1.43433 11.0742 2.94013 11.0742 4.79761C11.0742 6.65508 9.56841 8.16089 7.71094 8.16089C5.85346 8.16089 4.34766 6.65508 4.34766 4.79761Z" stroke="#4DA528" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M9.5977 15.1797H2.46098C1.34827 15.1797 0.558268 14.0954 0.898984 13.0362C1.80408 10.222 4.57804 8.18566 7.69301 8.18566C9.17897 8.18566 10.5566 8.64906 11.6895 9.43922" stroke="#4DA528" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M17.1035 15.1797V9.02734" stroke="#4DA528" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M20.1797 12.1035H14.0273" stroke="#4DA528" stroke-width="1.7" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                            </svg>
                                                            <span>12 Person</span>
                                ...
                                <div class="tab-pane fade" id="los-angelas-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="tour-listing">
                                                <a href="tour-single.html" class="tour-listing-image">
                                ...
                                <div class="tab-pane fade" id="manila-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-3">
                                            <div class="tour-listing">
                                                <a href="tour-single.html" class="tour-listing-image">
                ...
                <div class="row z-index3 relative">
                    ...
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs-activities justify-content-center" id="myTablist" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="ab-tab" data-bs-toggle="tab" data-bs-target="#ab-tab-pane" type="button" role="tab" aria-controls="ab-tab-pane" aria-selected="false">
                                                <span class="icon flex-five">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="cd-tab" data-bs-toggle="tab" data-bs-target="#cd-tab-pane" type="button" role="tab" aria-controls="cd-tab-pane" aria-selected="false">
                                                <span class="icon flex-five">
                                                    <svg width="59" height="55" viewBox="0 0 59 55" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M34.7241 5.70648C36.0557 5.50162 37.3873 6.42349 37.5921 7.75509" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M37.5921 7.75502C37.3872 6.42342 38.3091 5.09182 39.6407 4.88696" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M21.3057 3.45306C22.6373 3.2482 23.9689 4.17007 24.1737 5.50167" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M24.1737 5.5016C23.9689 4.17 24.8907 2.83841 26.2223 2.63354" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M49.8838 41.0452V50.5712" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        ...
                                                        <path d="M35.2362 34.0798V38.5868" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M20.3838 32.0311V34.1821C20.3838 35.5137 19.257 36.6405 17.9255 36.6405H8.60427C7.27267 36.6405 6.14594 35.5137 6.14594 34.1821V32.0311C6.14594 30.6995 7.27267 29.5728 8.60427 29.5728H17.9255C19.257 29.5728 20.3838 30.6995 20.3838 32.0311Z" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M13.2137 29.5728V36.6405" stroke="currentColor" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="col-lg-5">
                        <div class="content">
                            <div class="mb-50">
                                            <span class="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
                                            world</span>
                                <h2 class="title-heading mb-32 fadeInUp wow">
                                    Amazing Featured Tour<span class="text-gray font-yes ">Package</span>
                                    the world
                                </h2>
                                <p class="des-heading fadeInUp wow">Welcome to our Print 128 website! We are a
                            ...
                            <div class="inner-content flex-three">
                                ...
                                <p class="font-italic fadeInUp wow">
                                    Discover Great <span class="text-main">Discount</span>
                            ...
                            <div class="count-dow-wrap flex-three mb-50">
                                ...
                                <div class="count-down relative fadeInUp wow">
                                    <div class="featured-countdown">
                                        <div class="js-countdown" data-timer="21000000" data-labels="days,hours,minutes,seconds"></div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="tour-listing">
                                            ...
                                            <div class="tour-listing-content">
                                                ...
                                                <h3 class="title-tour-list">
                                                    <a href="tour-single.html">Days and
                                                        6 nights From
                                                        Moscow</a>
                                                </h3>
                                                <div class="review">
                ...
                <div class="row mb--20em relative z-index3">
                    <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.1s">
                        <div class="tf-counter center tf-countto">
                            ...
                            <div class="number-counter " data-to="5489" data-speed="2000" data-waypoint-active="yes">5489</div>
                    ...
                    <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.2s">
                        <div class="tf-counter center tf-countto">
                            <div class="icon mb-32">
                                <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_73_177)">
                                        <mask id="mask0_73_177" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="0" y="0" width="69" height="68">
                                        ...
                                        <g mask="url(#mask0_73_177)">
                                            ...
                                            <path d="M29.5166 49.2619C30.5896 58.3735 38.3375 65.4424 47.7375 65.4424H66.0866L60.9352 59.8227C64.1191 56.5225 66.0866 52.041 66.0866 47.0933C66.0866 37.6932 59.0178 29.9454 49.9061 28.8724" stroke="currentColor" stroke-width="3" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <div class="number-counter percen" data-to="99.9" data-speed="2000" data-waypoint-active="yes">99.9%</div>
                            <span class="line"></span>
                            <p class="title-counter">
                                Total Postive<br>Reviews
                            </p>
                        </div>
                    </div>
                    <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.3s">
                        <div class="tf-counter center tf-countto">
                            ...
                            <div class="number-counter plus" data-to="190" data-speed="2000" data-waypoint-active="yes">190+</div>
                            <span class="line"></span>
                            <p class="title-counter">
                                Tour<br>Completed
                            </p>
            ...
            <div class="tf-container">
                ...
                <div class="grid-three-destination">
                    <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.1s">
                        ...
                        <div class="destination-content">
                            ...
                            <div class="flex-two btn-destination">
                                <h6 class="title">
                                    <a href="single-destination.html">View all tours</a>
                                </h6>
                    ...
                    <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.5s">
                        <a href="single-destination.html" class="destination-imgae">
                            <span class="tour">3 tours</span>
                            <img src="images/destination/list4.jpg" alt="">
                        </a>
                        <div class="destination-content">
                        ...
                        <div class="adventure-content">
                            <nav class="mb-40 adventure-scroll">
                                <div class="nav nav-justified nav-tabs-adventure" id="nav-tab" role="tablist">
                                    <li class="nav-link flex-three active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-hiking" role="tab" aria-controls="nav-hiking" aria-selected="true">
                                        <i class="icon-Group1"></i>
                                        <span>Hiking & Tracking</span>
                                    </li>
                                    <li class="nav-link flex-three" id="nav-river-tab" data-bs-toggle="tab" data-bs-target="#nav-river" role="tab" aria-controls="nav-river" aria-selected="false">
                                        <i class="icon-river-1"></i>
                                        <span>River Cruises</span>
                                    </li>
                                    <li class="nav-link flex-three" id="nav-adventure-tab" data-bs-toggle="tab" data-bs-target="#nav-adventure" role="tab" aria-controls="nav-adventure" aria-selected="false">
                                        <i class="icon-adventure-1"></i>
                                        <span>Adventure Tour</span>
                                    </li>
                                    <li class="nav-link flex-three" id="nav-animals-tab" data-bs-toggle="tab" data-bs-target="#nav-animals" role="tab" aria-controls="nav-animals" aria-selected="false">
                                        ...
                                        <div class="col-6 col-sm-6 col-lg-3">
                                            <div class="tf-adventure flex-three mb-43">
                                                ...
                                                <div class="adventure-image">
                                                    ...
                                                    <h6 class="title-ad">
                                                        <a href="tour-single.html">Switzerland</a>
                                                    </h6>
            ...
            <div class="tf-container">
                <div class="row z-index3 relative">
                    <div class="col-lg-7 content-banner-contact">
                        <div class="mb-32">
                                        <span class="sub-title-heading text-main mb-15 font-yes fs-28-46 wow fadeInUp animated">Explore
                                        the
                                        world</span>
                        ...
                        <div class="flex-three">
                            ...
                            <address class="wow fadeInUp animated">
                                Contact us at <a href="mailto:@Hooktheme.co">@Hooktheme.co</a>
                                <br>
                            </address>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="center m0-auto w-text-heading">
                                        ...
                                        world</span>
                            <h2 class="title-heading mb-40 wow fadeInUp animated">
                                Latest news & articles <span class="text-gray font-yes">from</span>
                                the blog
                            </h2>
                        </div>
                    </div>
                        ...
                        <div class="tf-widget-blog blog-style">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 class="entry-title">
                                    <a href="blog-details.html">The 8 best things about
                                        Touristy</a>
                                </h3>
                                <p class="des">Business is the activity of making on cing or buying and selling
                                    pro
                                </p>
                                <a href="blog-details.html" class="btn-read-more">
                                    Read More <i class="icon-Vector-4"></i>
                                </a>
                            </div>
                        </div>
                    </div>
